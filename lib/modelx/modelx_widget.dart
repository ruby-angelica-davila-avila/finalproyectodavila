...
class ModelxWidget extends StatefulWidget {
  const ModelxWidget({Key key}) : super(key: key);

  @override
  _ModelxWidgetState createState() => _ModelxWidgetState();
}

class _ModelxWidgetState extends State<ModelxWidget> {
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Las plataformas del Model X unen las tecnologías de sistema de propulsión y batería para un performance, autonomía y eficiencia inigualables.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyText1
                                    .override(
                                      fontFamily: 'Poppins',
